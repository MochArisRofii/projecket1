...
cowImage.src = './assets/pdip.png'
const cowImage2 = new Image;
cowImage2.src = './assets/pdi.png'
...
function onMouseMove(event) { 
    if (isPlay) {
        //kolom 1
        if (event.clientX >= 499 && event.clientX <= 740 && cow.x >= 20 && cow.x <= 200) {
            //row1
        ...
        //kolom2
            ...
            //row3
            else if (event.clientY >= 433 && event.clientY <= 614 && cow.y >= 391 && cow.y <= 570) onUserClickRight()
            else onUserClickWrong()
        }
        //kolom3
